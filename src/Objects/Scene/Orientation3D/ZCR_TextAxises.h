...
struct ZCR_TextAxises
{
    ...
    {
        ZCR_TextAxis(ZCR_A_PositiveX, { 1.f, 0.f, 0.f }, "+X", ZC_PackColorUCharToUInt_RGB(225, 0, 0)),
        ZCR_TextAxis(ZCR_A_NegativeX, { -1.f, 0.f, 0.f }, "-X", ZC_PackColorUCharToUInt_RGB(180, 0, 0)),
        ZCR_TextAxis(ZCR_A_PositiveY, { 0.f, 1.f, 0.f }, "+Y", ZC_PackColorUCharToUInt_RGB(0, 225, 0)),
        ZCR_TextAxis(ZCR_A_NegativeY, { 0.f, -1.f, 0.f }, "-Y", ZC_PackColorUCharToUInt_RGB(0, 180, 0)),
        ZCR_TextAxis(ZCR_A_PositiveZ, { 0.f, 0.f, 1.f }, "+Z", ZC_PackColorUCharToUInt_RGB(0, 180, 225)),
        ZCR_TextAxis(ZCR_A_NegativeZ, { 0.f, 0.f, -1.f }, "-Z", ZC_PackColorUCharToUInt_RGB(0, 155, 225)),
    };
